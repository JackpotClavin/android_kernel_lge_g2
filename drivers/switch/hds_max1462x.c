...
#define EARMIC_MIN		1710000
#define EARMIC_MAX		2600000
#endif
...
#ifdef CONFIG_SWITCH_MAX1462X_WA
static void check_is_4pole(struct hsd_info *hi)
{
	HSD_DBG("3->4 polarity earjack\n");
...
static int lge_hsd_probe(struct platform_device *pdev)
{
	...
	hi->latency_for_key = msecs_to_jiffies(80); /* convert milli to jiffies */   
